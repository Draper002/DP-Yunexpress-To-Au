...
```text
app.py
scripts/generate_yunexpress_template.py
scripts/generate_dp_shipment_upload.py
scripts/sort_yunexpress_labels_by_sku.py
```

建议新建一个共享模块，例如 `scripts/paths.py`，集中处理：
...
cd "/源码所在目录/DP_Yunexpress_To_Au_Tool"
python3 -m venv .venv
