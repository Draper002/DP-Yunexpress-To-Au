...
def write_template(
    ...
    output_path = unique_path(
        output_dir
        / f"顺丰国际批量寄件_{ship_date}_{len(rows)}packages_{order_count}orders_{safe_business_type}.xlsm"
    )
...
def main() -> int:
    ...
    try:
        ...
        output_rows = build_sf_rows(carrier_orders, sku_map, args.business_type, args.battery)
